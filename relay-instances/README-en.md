...
# Relay Instance NIP-11 Information

Last Checked: 2026-06-26

## Overview

Survey results of NIP-11 limitation information for each relay instance.

## Limitation Information

| Relay | Software | max_message_length | max_subscriptions | max_limit | max_filters | max_subid_length | max_event_tags | max_content_length |
|-------|----------|-------------------|-------------------|-----------|-------------|-----------------|----------------|-------------------|
...
**Note**: `-` indicates the field is not published in NIP-11
